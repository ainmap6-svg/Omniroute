...
> Railway `railway.toml` ni endi qabul qilmaydi (eskirgan). Healthcheck va shu kabi
> sozlamalar dashboard yoki API orqali qo'yiladi: **Settings -> Deploy -> Healthcheck Path: `/healthz`**.
